                    ...
                    <div class="col-md-12">
                        <div class="card" style="border-radius: 100px;">
                            <div class="card-body" style="width: 100%; height: 100%; background: white; border-radius: 30px">
                                <div class="row align-items-center">
                                    <a href="<?=base_url('tanggal_tournament')?>" class="col-md-6" style="margin-top:10px">
                                        <div class="text-center" style="border: 2px solid #F15C67; height: 50px;">
                                            <div style="color: #F15C67; font-size: 30px; font-family: Poppins; font-weight: 900; word-wrap: break-word;">TANGGAL</div>
                                        </div>
                                    </a>
                                    <a href="<?=base_url('team_tournament')?>" class="col-md-6" style="margin-top:10px">
                                        <div class="text-center" style="border: 2px solid #F15C67; height: 50px;">
                                            <div style="color: #F15C67; font-size: 30px; font-family: Poppins; font-weight: 900; word-wrap: break-word;">TEAM</div>
                                        </div>
                                    </a>
                                </div>
                            </div>

        ...
        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-body">
                    <input type="text" name="id_user" class="form-control" placeholder="asdf@gmail.com" value="<?= $this->session->userdata('id_user') ?>" hidden>
                    <?php
                    ...
                    $kodetampil = $this->session->userdata('id_user') . $batas;
                    ?>
                    <input type="text" name="id_anggota_team" class="form-control" placeholder="asdf@gmail.com" value="<?= $kodetampil ?>" hidden>
                    <span id="modal-body-update-or-create">
                        <div class="form-group">
                            <input type="text" name="ask" class="form-control" placeholder="SMAN 2 KOTA BANJAR" value="<?= $this->session->userdata('asal_sekolah') ?>" hidden>
                        </div>
                        <div class="form-group">
